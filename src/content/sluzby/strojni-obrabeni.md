...
scope:
  ...
  - Broušení
  - Obrážení
  - Ohraňování a stáčení
  - Zakázkové opracování dílů
equipment:
  - name: Hrotový soustruh
    role: Soustružení hřídelí, pístnic a rotačních dílů do průměru 800 mm a délky 5 000 mm.
  - name: Horizontální vyvrtávačka
    role: Obrábění větších dílců a skříní, maximální dílec 1 250 × 1 400 × 1 120 mm.
specs:
  - title: Soustružení
    rows:
      - label: Maximální průměr
        value: 800 mm
      - label: Maximální délka
        value: 5 000 mm
  - title: Horizontální vyvrtávačka
    rows:
      - label: Maximální dílec
