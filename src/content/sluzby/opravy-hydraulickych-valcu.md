---
title: Opravy hydraulických válců
order: 2
eyebrow: Hydraulika
...
scope:
  ...
  - Opravy pístnic a pístních tyčí
  - Demontáž hydraulických válců
  - Renovace uložení a těsnicích ploch
  - Návaznost na strojní obrábění, svařování a renovace
equipment:
  - name: Povolovací lavice
    role: Demontáž a montáž hydraulických válců včetně zatuhlých spojů, do délky 4 000 mm a tlaku 300 barů.
  - name: Hrotový soustruh
    role: Obrábění a renovace pístnic do průměru 800 mm a délky 5 000 mm.
specs:
  - title: Povolovací lavice
    rows:
      - label: Maximální délka válce
        value: 4 000 mm
      - label: Maximální tlak
        value: 300 barů
gallery: sl-opravy-hydraulickych-valcu
related: [opravy-strojnich-zarizeni, strojni-obrabeni, opravy-zemedelske-a-stavebni-techniky]
...
## S čím se na nás obracejí nejčastěji

Zadřené a ohnuté pístnice, poškozené těsnicí plochy, netěsnosti a úniky oleje,
poškozená oka a čepy. U lesnické a zemědělské techniky děláme i generální opravy
hydraulických ruk a kleští.
